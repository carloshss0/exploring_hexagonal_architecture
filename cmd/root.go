...
var rootCmd = &cobra.Command{
	Use:   "exploring_hexagonal_architecture",
...
func init() {
	...
	// rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.exploring_hexagonal_architecture.yaml)")
